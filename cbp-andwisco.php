...
function cbp_andwisco_intro() {
	$intro = array(
		'heading'    => 'We are an <strong class="has-green-900-color">andwis<span class="has-green-400-color">.</span></strong> group company.',
...
function cbp_andwisco_services() {
	$services = array(
		...
		array(
			...
			'subtitle' => 'Simple, fast, and fully assured asbestos compliance',
			'content'  => 'For your peace-of-mind, andwis offers complete asbestos management and remediation solutions throughout the UK. Our services range from UKAS-accredited surveys to HSE-licensed removal, management plans, air monitoring, and training.',
		...
		<div class="container">
			<div class="row g-4">
				...
				<div class="col-12 col-xxl-8">
					<div class="andwis-items" data-andwis>
						<?php
